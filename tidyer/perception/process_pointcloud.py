...
class TidyerPerceptionNode(Node):
            ...
            json.dumps(
                {
                    # 0 93 93
                    # 28 103
                    # green sample: HSV(170.3, 96, 30) -> OpenCV (85, 245, 77)
                    # 'red': [[0, 100, 70], [12, 255, 255]],
                    'blue': [[90, 80, 50], [130, 255, 255]],
                    'green': [[60, 110, 40], [95, 255, 210]], #[[60, 120, 60], [95, 255, 200]]
                    'yellow': [[15, 100, 100], [32, 255, 255]], #[[18, 80, 80], [35, 255, 255]],
                }
            ),
        )
    ...
    def _find_free_spot(
        ...
        free_u, free_v = int(candidates_u[idx]), int(candidates_v[idx])
